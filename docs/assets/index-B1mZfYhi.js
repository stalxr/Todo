...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "topbar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "logo", children: "Todo App" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "nav-links", children: token ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/todos", className: "nav-link", children: "Задачи" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: logout, className: "link-button nav-primary", children: "Выйти" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "nav-link", children: "Войти" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "nav-link nav-primary", children: "Регистрация" })
      ] }) })
    ] }),
...
async function updateTodo(id2, body) {
  return request(
    `/todos/${id2}`,
    {
      method: "PUT",
...
function Login() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (typeof e2 === "string") setErr(e2);
      else if (e2 == null ? void 0 : e2.message) setErr(e2.message);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Войти в аккаунт" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "card-subtitle", children: "Авторизуйтесь, чтобы увидеть свои задачи и управлять ими." })
    ] }),
    ...
    err && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error", role: "alert", children: err }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Нет аккаунта?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "inline-link", children: "Зарегистрироваться" })
    ] })
  ] });
}
function Register() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Создать аккаунт" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "card-subtitle", children: "Заполните форму, чтобы начать вести список своих задач." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "register-email", children: "Email" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          id: "register-email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "register-password", children: "Пароль" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Создать аккаунт" })
    ] }),
    msg && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "info", children: msg }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Уже есть аккаунт?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "inline-link", children: "Войти" })
    ] })
  ] });
}
function Todos() {
  ...
  async function onToggle(todo) {
    try {
      ...
      setTodos((prev) => prev.map((t2) => t2.ID === updated.ID ? updated : t2));
    } catch (e) {
      setErr(e instanceof Error ? e.message : String(e));
    }
  }
...
createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(Root, {}));
